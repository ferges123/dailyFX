...
<p align="center">
  <img src="frontend/public/pwa-512x512.png" alt="DailyFX logo" width="140" />
</p>

### *Turn your static photo library into a dynamic, AI-powered creative playground.*

---
**TLDR: DailyFX is a self-hosted web app for Immich that automatically picks photos, applies creative effects or AI transformations, lets you review the results, and uploads accepted images back to Immich with metadata preserved.**
...
## Features & Creative Effects

DailyFX has over 40 built-in creative modules and Generative AI effects to transform your photos.

👉 **[See the full list of available effects and AI modules in docs/effects.md](docs/effects.md)**
...
**CLI handoff:**
- Run scheduled generation on the host using `./dailyfx-agent --schedule-id 1 --target agy`.
- For the full orchestrator CLI reference, including daemon mode, custom templates, vision pipelines, and troubleshooting, see the [dailyfx-agent documentation](docs/dailyfx-agent.md).
