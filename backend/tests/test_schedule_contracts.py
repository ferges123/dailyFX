...
def test_schedule_response_adapter_preserves_preset_names_and_ids():
    ...
    try:
        ...
        db.add_all([people_preset, effect_preset, notif_one, notif_two])
        db.commit()
        ...
        response = ScheduleResponse.from_model(
            schedule,
            people_preset_name=people_preset.name,
...
def test_list_schedules_returns_adapter_values():
    ...
    try:
        ...
        db.add_all([people_preset, effect_preset, notif])
        db.commit()
        ...
        assert response.people_preset_name == "Filter B"
...
def test_create_schedule_rejects_ai_photo_selection_without_vision_provider():
    ...
    db = SessionLocal()
    try:
        people_preset = PeoplePresetModel(name="Filter C", album_ids_json="[]", person_filters_json="[]")
