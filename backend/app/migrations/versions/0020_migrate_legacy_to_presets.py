...
def upgrade() -> None:
    ...
    (
        automation_enabled, automation_schedule, automation_filters_json,
        modification_groups_json, notification_provider, notification_url,
        notification_topic, encrypted_notification_token, webhook_url,
        automation_last_run_at, default_album_name,
    ) = row
    ...
    conn.execute(text(
        "INSERT INTO effect_presets (name, groups_json) VALUES (:name, :groups)"
