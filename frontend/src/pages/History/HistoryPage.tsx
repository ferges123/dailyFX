    ...
    if (isLoading && filteredHistoryItems.length === 0) {
      return (
        <div className="grid gap-4 lg:h-[calc(100dvh-7rem)] lg:min-h-0 lg:grid-cols-[330px_minmax(0,1fr)] lg:items-stretch">
          ...
          <div className="flex flex-col min-h-0 rounded-xl md:rounded-2xl border border-stone-200 bg-stone-50/60 p-1.5 md:p-2 h-[calc(100dvh-12rem)] md:h-[calc(100dvh-7.5rem)] lg:h-full">
