...
export const EffectPopularityChart = memo(function EffectPopularityChart({
  ...
  return (
    <div
      className="app-surface p-4 md:p-6"
      data-testid="effect-popularity-chart"
    >
      <div className="mb-4 flex items-center gap-2">
        <Flame
          size={20}
          className={
            activeTab === 'ai' ? 'text-purple-700' : 'text-emerald-700'
          }
        />
        <div>
          <h2 className="text-sm font-bold text-stone-900 md:text-base">
            Popular Effects
          </h2>
          <p className="text-[11px] text-stone-500">
            Most frequently used effects in this category
          </p>
        </div>
      </div>
